...
<template>
  ...
  >
    ...
    <div class="group-header w-full flex items-center">
      ...
      <!-- Group Collapse Icon -->
      <feather-icon :class = "[{'rotate90' : openItems},
      'feather-grp-header-arrow']" :icon=" bottom ? 'ChevronDownIcon' : $vs.rtl
      ? 'ChevronLeftIcon' : 'ChevronRightIcon' svg-classes= "w-4 h-4" />
    </div>
    <!-- /Group Label -->
...
<style lang="scss">
@import "@/assets/scss/croxx/components/horizontalNavMenuGroup.scss";
</style>
