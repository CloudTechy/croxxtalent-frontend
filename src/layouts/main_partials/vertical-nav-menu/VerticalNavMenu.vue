    ...
    >
      <div @mouseenter="mouseEnter" @mouseleave="mouseLeave">
        ...
        <component :is="scrollbarTag" ref="verticalNavMenuPs" class="scroll-area-v-nav-menu pt-2" :settings="settings" @ps-scroll-y="psSectionScroll" @scroll="psSectionScroll" :key="$vs.rtl">
          ...
          <!-- Nav Group Header -->
          <span class="navigation-header truncate" v-show="!verticalNavMenuItemsMin">My Account</span>

          <!-- Log Out Menu  -->
          <div class="vs-sidebar--item" :class="[{ 'vs-sidebar-item-active': activeLink('settings') }]">
            <router-link :to="{ name: 'settings' }" tabindex="-1" exact :class="[{ 'router-link-active': activeLink('settings') }]">
          ...
          <br>
          <!-- Nav Group Header -->
          <span class="navigation-header truncate" v-show="!verticalNavMenuItemsMin">Support</span>

          <div class="vs-sidebar--item" :class="[{ 'vs-sidebar-item-active': activeLink('contact') }]">
            <router-link :to="{ name: 'contact' }" tabindex="-1" exact :class="[{ 'router-link-active': activeLink('contact') }]">
