    ...
    <vx-card id="invoice-container">
      ...
      <div class="vx-row leading-loose p-base">
        <div class="vx-col w-1/2 mt-base">
          <img src="@/assets/images/logoicon.png" alt="croxx-logo" width="90" />
        </div>
      ...
      <div class="p-base">
        <!-- INVOICE TASKS TABLE -->
        <vs-table hover-flat :data="invoiceData.tasks">
          <!-- HEADER -->
          <template slot="thead">
            <vs-th class="pointer-events-none">TASK DESCRIPTION</vs-th>
            <vs-th class="pointer-events-none">Duration</vs-th>
          ...
          <template slot-scope="{ data }">
            <vs-tr v-for="(tr, index) in data" :key="index">
              ...
              <vs-td :data="data[index].duration">{{
                data[index].duration
              }}</vs-td>
        ...
        <vs-table hover-flat class="w-1/2 ml-auto mt-4" :data="invoiceData">
          <vs-tr>
      ...
      <div class="flex flex-wrap items-center justify-end">
        <div id="payment-btn" class="flex items-center">
          <vs-button
            class="mb-base mr-3"
            icon-pack="feather"
            icon="icon icon-file"
    ...
    return {
      ...
      invoiceData: {
        tasks: [
          {
            id: 1,
            task: "Croxx Monthly subscription",
            duration: "30 Days",
            rate: 15,
            amount: 90000
          }
