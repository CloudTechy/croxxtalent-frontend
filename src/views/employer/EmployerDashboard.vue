      ...
      <div class="vx-col w-full lg:w-1/2 mb-base">
        ...
        >
          ...
          <p class="xl:w-3/4 lg:w-4/5 md:w-2/3 w-4/5 mx-auto text-white">
            Increase your recruiting efficiency, find and engage talents.
          </p>
        </vx-card>
      </div>
  ...
  methods: {
    ...
    loadCampaigns() {
      ...
      this.$store
        ...
        .then(() => {
          if (this.$store.state.users.loadingCampaignsDataSet !== true) {
            this.totalCampaigns = this.$store.state.users.campaignsDataSetTotal;
          }
        });
    }, // loadCampaigns()
